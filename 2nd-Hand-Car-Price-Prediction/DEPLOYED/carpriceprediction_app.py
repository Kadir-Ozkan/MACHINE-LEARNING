...
st.video("https://www.youtube.com/watch?v=qC3PRqHqnfE")
...
a = st.radio("Select a color",("blue","orange","yellow")) #radio button
...
option2 = st.slider("Select a number", min_value=0.2, max_value=30.2, value=5.2, step=0.2) #yukarda integerla başladığından onunla devam etmelisin
...
#time input
the_time=st.time_input("The time is", datetime.time(8,45))  #yazmazsan 00:00
...
#data_framest.table(df.head())
st.table(df.head()) #statik duz tablo
